  ...
  return (
    <form onSubmit={submit} className="space-y-3">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full rounded-full bg-[#ff5625] py-3 text-sm font-medium text-white transition-colors glow-primary-hover hover:bg-[#ff5625]/90 disabled:opacity-50"
      >
