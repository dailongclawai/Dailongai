  ...
  return (
    <div className="space-y-12 py-4">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <Link href="/portal/dealer/orders/new" className="rounded-full bg-[#ff5625] px-6 py-2.5 text-sm font-medium text-white transition-colors glow-primary-hover hover:bg-[#ff5625]/90">
          + Ghi nhận đơn mới
        </Link>
      </div>
      ...
      <section className="grid grid-cols-1 gap-6 md:grid-cols-12 md:gap-10">
        ...
        <div className="space-y-4 md:col-span-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-xl border border-[#3d3f41]/40 bg-[#1e2022] p-4">
      ...
      <section className="rounded-3xl border border-[#3d3f41]/40 bg-[#1e2022] p-8">
        ...
        <div className="mt-10">
          <div className="relative h-1 rounded-full bg-[#282a2c]">
            <div
              className="absolute left-0 top-0 h-1 rounded-full bg-gradient-to-r from-[#ff5625] to-[#ff5625]"
              ...
              >
                <div
                  className={`h-4 w-4 rounded-full border-2 ${
                    unitsYtd >= t.minUnits ? 'border-[#ff5625] bg-[#ff5625]' : 'border-[#3d3f41]/70 bg-[#121416]'
                  }`}
                />
              </div>
            ))}
      ...
      <section>
        <div className="flex items-baseline justify-between border-b border-[#3d3f41]/40 pb-2">
          <div>
        ...
        {orders.length === 0 ? (
          <div className="mt-6 rounded-xl border-2 border-dashed border-[#3d3f41]/50 p-12 text-center text-sm text-[#e2e2e5]/60">
            <p>Chưa có đơn nào ghi nhận.</p>
          </div>
        ) : (
          <div className="mt-6 divide-y divide-[#3d3f41]/30">
