    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-black/60" onClick={onClose}>
      <div className="h-full w-full max-w-md overflow-y-auto bg-[var(--crm-s2)] p-6" onClick={e => e.stopPropagation()}>
        ...
        <div className="space-y-3">
          ...
          <button onClick={() => void save()} disabled={saving} className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#e8692a] py-3 font-bold text-white disabled:opacity-50">
