    ...
    <tr className="border-t border-[#3d3f41]/40 hover:bg-[#282a2c]/40">
      ...
      <td className="px-4 py-3 text-right">
        <div className="flex justify-end gap-2">
          <button onClick={approve} disabled={busy} className="rounded-full bg-[#ff5625] px-3 py-1.5 text-xs font-medium text-white glow-primary-hover hover:bg-[#ff5625]/90 disabled:opacity-50">Duyệt</button>
