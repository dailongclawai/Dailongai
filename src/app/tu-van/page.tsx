...
export const metadata: Metadata = {
  title: "Tư vấn máy laser trị liệu Đại Long | Zhi Dun bảo hành 5 năm",
  description:
    "Để lại thông tin để nhận tư vấn miễn phí về máy laser trị liệu (laser bán dẫn) Zhi Dun — giấy phép thiết bị y tế TBYT 260001468/PCBB-HN, bảo hành chính hãng 5 năm.",
  alternates: { canonical: "/tu-van" },
};

const trustPoints = [
  "Giấy phép thiết bị y tế số TBYT 260001468/PCBB-HN do Sở Y tế Hà Nội cấp.",
  "Zhi Dun bảo hành chính hãng 5 năm.",
        ...
        <section className="pt-32 sm:pt-40 pb-16 sm:pb-20 px-5 sm:px-8 lg:px-12 2xl:px-20 max-w-screen-2xl mx-auto">
          <div className="max-w-3xl">
            ...
            <p className="text-secondary text-sm sm:text-base leading-relaxed max-w-2xl">
              Để lại thông tin, đội ngũ Đại Long - công nghệ chăm sóc sức khoẻ sẽ liên hệ tư vấn miễn phí về máy laser trị liệu (laser bán dẫn) Zhi Dun phù hợp với nhu cầu của Quý khách.
            </p>
          </div>
