...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen items-start justify-center px-4 py-12 sm:items-center">
      <div className="w-full max-w-md space-y-6 rounded-2xl border border-[#ff8a50]/20 bg-gradient-to-br from-[#ff8a50]/[0.04] via-[#1a1c1f] to-[#1a1c1f] p-7 sm:p-9">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-5 inline-flex items-center gap-1.5 rounded-full border border-[#ff8a50]/40 bg-[#e8692a]/10 px-3 py-1 text-[10px] uppercase tracking-[0.3em] text-[#ff8a50] font-bold">
          ...
          <h1 className="mt-3 font-headline text-3xl font-bold leading-[1.1] tracking-tight text-[#e2e2e6] sm:text-4xl">
            ...
            <span className="bg-gradient-to-r from-[#ff8a50] via-[#ffb77d] to-[#f59e0b] bg-clip-text text-transparent">
        ...
        {ref && (
          <p className="rounded-lg border border-[#ff5625]/30 bg-[#ff5625]/[0.08] px-3 py-2 text-xs text-[#ff5625]">
        ...
        <form onSubmit={submit} className="space-y-4">
          <div>
            <label htmlFor="email" className="mb-1.5 block text-xs text-[#b3aca8]">{t('portal.auth.common.email_label')}</label>
            <input
              id="email"
              type="email"
              value={email}
              ...
              className="w-full rounded-xl border border-[#49443f] bg-[#0c0e11] px-4 py-3.5 text-sm text-[#e2e2e6] placeholder:text-[#b3aca8]/60 outline-none focus:border-[#ff8a50]"
            />
          </div>
          <div>
            <label htmlFor="password" className="mb-1.5 block text-xs text-[#b3aca8]">{t('portal.auth.common.password_label')}</label>
            <PasswordInput
              id="password"
              value={password}
          ...
          <button
            type="submit"
            disabled={busy}
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#e8692a] py-3.5 text-sm font-bold text-white transition-colors hover:bg-[#e8692a]/90 disabled:opacity-50"
          >
        ...
        <div className="flex items-center gap-3 text-[11px] text-[#b3aca8]">
          <span className="h-px flex-1 bg-[#49443f]" />
        ...
        <p className="border-t border-[#49443f] pt-5 text-center text-sm text-[#b3aca8]">
