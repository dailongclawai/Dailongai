...
export default function PendingPage() {
  ...
  return (
    <PortalShell variant="dealer">
      <div className="portal-glass mx-auto max-w-xl space-y-6 rounded-3xl border border-[#5b4039]/40 p-10 text-center">
        <p className="text-[11px] uppercase tracking-[0.3em] text-[#ffb5a1]">Tình trạng</p>
        ...
        <div className="rounded-xl bg-[#2c1c17] p-4 text-left text-xs text-[#fadcd5]/60">
          <p className="mb-1 font-semibold text-[#fadcd5]">Trong khi chờ:</p>
