...
export default function PhoneSignupPage() {
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-10">
      <div className="portal-glass w-full max-w-md space-y-6 rounded-3xl border border-[#3d3f41]/40 p-10 text-center">
        ...
        <Link
          ...
          className="inline-block rounded-full bg-[#ff5625] px-6 py-2.5 text-sm font-medium text-white glow-primary-hover hover:bg-[#ff5625]/90"
        >
          ← Quay lại đăng ký
        </Link>
      </div>
