  ...
  return (
    <PortalShell variant="admin" nav={<AdminNav />}>
      ...
      <div className="mb-8 rounded-2xl border border-white/12 bg-[#1e2022] p-6">
        ...
        <div className="mt-4">
          <button onClick={save} disabled={busy} className="rounded-full bg-[#ff5625] px-6 py-2.5 text-sm font-medium text-white transition-colors glow-primary-hover hover:bg-[#ff8a5c] disabled:opacity-50">
        ...
        <table className="w-full min-w-[560px] text-left text-sm">
          ...
          <tbody>
            {models.length === 0 ? (
              ...
              <tr key={m.id} className="border-t border-white/12 hover:bg-white/5">
                ...
                <td className="px-4 py-3 text-center">
                  <span className={`rounded-full px-2 py-0.5 text-[10px] font-medium uppercase ${m.active ? 'bg-[#34d399]/15 text-[#34d399]' : 'bg-white/10 text-[#e2e2e5]/50'}`}>
