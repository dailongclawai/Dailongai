...
export default function TeamDealerDetail() {
  ...
  return (
    <PortalShell variant="supervisor">
      ...
      <div className="mt-8 rounded-2xl border border-[#ff5625]/30 bg-[#ff5625]/5 p-6">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-3">
          <select
            ...
            className="rounded-lg border border-[#3d3f41]/50 bg-[#1e2022] px-3 py-2 text-sm text-[#e2e2e5] focus:border-[#ff5625]"
          >
      ...
      <div className="mt-8 overflow-hidden rounded-2xl border border-[#3d3f41]/40 bg-[#1e2022]">
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            {orders.map((o) => (
              <tr key={o.id} className="border-t border-[#3d3f41]/40">
